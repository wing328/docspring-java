...
public class SubmissionAction {
  ...
  * @throws IOException if the JSON Object is invalid with respect to SubmissionAction
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (SubmissionAction.openapiRequiredFields.isEmpty()) {
          return;
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!SubmissionAction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SubmissionAction` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
