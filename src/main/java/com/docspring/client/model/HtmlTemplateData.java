...
public class HtmlTemplateData {
  ...
  * @throws IOException if the JSON Object is invalid with respect to HtmlTemplateData
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (HtmlTemplateData.openapiRequiredFields.isEmpty()) {
          return;
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!HtmlTemplateData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `HtmlTemplateData` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
