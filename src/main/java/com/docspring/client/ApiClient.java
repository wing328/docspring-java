...
import com.docspring.client.auth.Authentication;
import com.docspring.client.auth.HttpBasicAuth;
import com.docspring.client.auth.HttpBearerAuth;
import com.docspring.client.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    private String basePath = "https://api.docspring.com/api/v1";
    ...
    public ApiClient() {
        ...
        authentications.put("api_token_basic", new HttpBasicAuth());
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.docspring.com/api/v1
